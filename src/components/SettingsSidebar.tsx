...
import { ETERNITY_LOGO_URL, ETERNITY_COMPANY_NAME } from "@/constants/branding";
import { Sparkles, Key, Brain } from "lucide-react";
            ...
            <summary className="cursor-pointer text-lg font-bold text-gray-800 mb-4 list-none">
              <span className="flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <Brain className="w-5 h-5 text-gray-600" /> View Business Logic
                </span>
